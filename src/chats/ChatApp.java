...
public class ChatApp {
    public static void main(String[] args){
        ...
        Logovanje manager = Logovanje.getInstance(); /// ! ! ! !
        ...
        Korisnik k1 = manager.prijava("Luka","aaB1234");
        Korisnik k2 = manager.prijava("kalu","bbN567");
        Korisnik k3 = manager.prijava("Boban","nnB9008");
        Korisnik k4 = manager.prijava("Pera","kkI56700");
        Korisnik k5 = manager.prijava("Zeka","Loo1233");
